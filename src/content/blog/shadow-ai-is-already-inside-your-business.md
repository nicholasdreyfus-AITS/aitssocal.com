...
faq:
  - question: 'How common is shadow AI in the workplace?'
    answer: 'Very common. Microsoft''s 2025 Work Trend Index found 71% of workers have used unapproved AI tools at work — seven out of ten people, consistent across industries and company sizes. Most aren''t being careless; they''re trying to work faster.'
  - question: 'How much does a shadow AI breach cost?'
    answer: 'According to IBM''s 2025 Cost of a Data Breach Report, shadow AI adds about $670,000 to the cost of a breach on average, bringing the total AI-associated breach cost to roughly $4.63M. These breaches also take an average of 247 days — about eight months — to even detect.'
  - question: 'Does using an enterprise AI tool like Microsoft Copilot make us safe?'
    answer: 'Not on its own. In June 2025 a critical Copilot vulnerability was rated 9.3 out of 10 in severity. Buying an enterprise tool is the starting line, not the finish line — the governance layer (policy, access controls, monitoring, training) is what actually protects you, and IBM found 63% of breached organizations had no AI governance policy at all.'
  - question: 'What should we do about shadow AI this week?'
    answer: 'Four steps: (1) find out what AI tools your team is actually using, (2) document every tool and use case, (3) put a one-page written AI acceptable-use policy in place, and (4) have a real conversation with a technology partner who works at the intersection of AI, security, and compliance.'
---
